...
public class SwerveModule {
  ...
  private void setAngle(SwerveModuleState desiredState) {
    ...
    Rotation2d angle =
        (Math.abs(desiredState.speedMetersPerSecond) <= (Constants.Swerve.maxSpeed * 0.1))
            ? lastAngle
            : desiredState.angle;
  ...
  public Rotation2d getCanCoder() {
    SmartDashboard.putNumber("" + moduleNumber + " " + " Angle Encoder ", angleEncoder.getAbsolutePosition().getValue());
  ...
  public SwerveModulePosition getState() {
    ...
    return new SwerveModulePosition(driveEncoder.getVelocity(), getCanCoder());
  }
}
