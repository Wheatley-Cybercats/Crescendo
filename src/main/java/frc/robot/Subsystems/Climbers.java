...
public class Climbers extends SubsystemBase {
    TalonFX leftClimbMotor = new TalonFX(RobotProperties.Climber.LEFT_CLIMB_MOTOR_ID, "The CANivore");
    TalonFX rightClimbMotor = new TalonFX(RobotProperties.Climber.RIGHT_CLIMB_MOTOR_ID, "The CANivore");
