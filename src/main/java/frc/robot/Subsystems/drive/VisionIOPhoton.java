...
public class VisionIOPhoton implements VisionIO{
    ...
    public VisionIOPhoton(String camName){
        ...
        photonPoseEstimator = new PhotonPoseEstimator(AprilTagFieldLayout.loadField(AprilTagFields.kDefaultField), PhotonPoseEstimator.PoseStrategy.MULTI_TAG_PNP_ON_COPROCESSOR, photonCamera, Constants.robotToPhoton);
    ...
    public Pose2d getBotPose(){
        ...
        return visionEst.map(estimatedRobotPose -> estimatedRobotPose.estimatedPose.toPose2d()).orElse(null);
